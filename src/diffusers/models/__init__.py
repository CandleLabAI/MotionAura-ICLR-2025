...
if is_torch_available():
    ...
    _import_structure["autoencoders.autoencoder_kl_motionaura"] = ["AutoencoderKLMotionAura"]
    ...
    _import_structure["transformers.motionaura_transformer_3d"] = ["MotionAuraTransformer3DModel"]
