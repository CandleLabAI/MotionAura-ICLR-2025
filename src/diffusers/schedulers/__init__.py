...
try:
    ...
    _import_structure["scheduling_ddim_motionaura"] = ["MotionAuraDDIMScheduler"]
    ...
    _import_structure["scheduling_dpm_motionaura"] = ["MotionAuraDPMScheduler"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    ...
    try:
        ...
        from .scheduling_dpm_motionaura import MotionAuraDPMScheduler
        from .scheduling_ddim_motionaura import MotionAuraDDIMScheduler
